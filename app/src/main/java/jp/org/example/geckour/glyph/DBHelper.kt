...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DBHelper.DB_NAME, null, DBHelper.DB_VERSION) {
    ...
    public val SETS = arrayOf(
            ...
            arrayOf("5", "ADAPT,THOUGHT,DISCOVER,SIMPLE,SUCCESS", null),
            ...
            arrayOf("5", "CLEAR,YOUR,MIND,CREATIVITY,GROW", null),
            arrayOf("5", "CLEAR,YOUR,MIND,MORE,BALANCE", null),
            ...
            arrayOf("5", "HAVE,HARMONY,TOGETHER,END,MYSTERY", null),
            arrayOf("5", "HELP,ENLIGHTENMENT,CAPTURE,ALL,PORTAL", null),
            arrayOf("5", "HELP,GAIN,KNOWLEDGE,INSIDE,RESISTANCE", null),
            arrayOf("5", "HELP,US,PROGRESS,STRONG,VICTORY", null),
            ...
            arrayOf("5", "INTERRUPT,ENLIGHTENED,TECHNOLOGY,CAPTURE,VICTORY", null),
            arrayOf("5", "INTERRUPT,MESSAGE,LOSE,COLLECTIVE,POTENTIAL", null),
            ...
            arrayOf("5", "MYSTERY,BEFORE,PURE,KNOWLEDGE,AFTER", null),
            ...
            arrayOf("5", "YOU,HIDE,CHAOS,INSIDE,BODY", null),
            arrayOf("4", "ABANDON,FEAR,SEE,FUTURE", null), //#4
            arrayOf("4", "ABANDON,FEAR,DEFEND,FUTURE", null),
            arrayOf("4", "ADAPT,THOUGHT,DISCOVER,EVOLUTION", null),
            ...
            arrayOf("4", "BEFORE,MYSTERY,AFTER,KNOWLEDGE", null),
            ...
            arrayOf("4", "ENLIGHTENED,CAPTURE,VICTORY,TOGETHER", null),
            ...
            arrayOf("4", "HIDE,CHAOS,INSIDE,BODY", null),
            arrayOf("4", "HELP,GAIN,CREATE,PURSUE", null),
            arrayOf("4", "HELP,ENLIGHTENED,STRONG,VICTORY", null),
            arrayOf("4", "HELP,SHAPERS,CREATE,FUTURE", null),
            arrayOf("4", "HELP,US,SAVE,US", null),
            arrayOf("4", "HELP,RESISTANCE,STRONG,VICTORY", null),
            ...
            arrayOf("4", "INTERRUPT,MESSAGE,GAIN,ADVANCE", null),
            arrayOf("4", "JOURNEY,INSIDE,IMPROVE,SOUL", null),
            arrayOf("4", "KNOWLEDGE,HELP,GAIN,VICTORY", null),
            ...
            arrayOf("4", "XM,NOURISH,STRONG,CREATIVITY", null),
            ...
            arrayOf("3", "CAPTURE,VICTORY,TOGETHER", null),
            ...
            arrayOf("3", "CLEAR,YOUR,MIND", null),
            ...
            arrayOf("3", "INTERRUPT,ENLIGHTENED,TECHNOLOGY", null),
            ...
            arrayOf("3", "TECHNOLOGY,CAPTURE,VICTORY", null),
            arrayOf("3", "TOGETHER,END,MYSTERY", null),
            ...
            arrayOf("3", "XM,GROW,CREATIVITY", null),
            arrayOf("3", "XM,NOURISH,CIVILIZATION", null),
            arrayOf("3", "YOU,HIDE,CHAOS", null),
            arrayOf("2", "ADAPT,TECHNOLOGY", null), //#2
            ...
            arrayOf("2", "INTERRUPT,EVOLUTION", null),
